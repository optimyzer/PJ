...
$strSQL = "INSERT INTO HOMEPROLEADSSTAGE ";
	$strSQL .="(CUSTEMAIL,FIRSTNAME,LASTNAME,PHONE1,LEADTYPE,NATURE,SCOPE,ADDRESS,CITY,STATE,ZIPCODE,IPADDRESS,ORIGIN,REFERER,SUBID,SUBID2,TASKID)";
	$strSQL .="VALUES";
	$strSQL .="('".$UserEmail."','".$Firstname."','".$Lastname."','".$UserPhone."','".$leadtype."','".$nature."','".$scope."','".$address."','".$city."','".$state."','".$zip."','".$ip."','".$origin."','".$ref."','".$subid."','".$subid2."','".$taskid."')";
