...
if(!empty($_POST)){
	...
	//--- to get task id on the basis of nature and scope
	$scopes=oci_parse($conn,"select TASKID from HOMEPROTASKS where NATURE='$nature' and SCOPE='$scope'");
            ...
            <div class="col-sm-12 connecttion">
				...
				<div class="ContactForm">
                  <form id="hpcontact" method="post" action="insert" >
					 ...
					 <input type="hidden" name ="leadtype" value="<?php echo $leadtype; ?>">
